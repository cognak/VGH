...
Процедура СписокУстройствПриАктивизацииСтроки(Элемент)
	...
	Если Элементы.Найти("Настроить") <> Неопределено Тогда
		Элементы.Настроить.Доступность = (ТипЗнч(Элемент.ТекущаяСтрока) = Тип("СправочникСсылка.вгх_Настройка"));
	КонецЕсли;
...
Процедура ОбновитьПользовательскийИнтерфейс()
	...
	Если вгхОбщегоНазначенияКлиентСервер.ЭтоМобильныйКлиент() Тогда
...
Процедура ТестУстройства(Команда)
	ТекущаяСтрока=Элементы.СписокУстройств.ТекущиеДанные;
	Если ТекущаяСтрока=Неопределено Тогда
		Возврат;
	КонецЕсли; 
	ПараметрыФорма= Новый Структура;
	ПараметрыФорма.Вставить("Устройство",ТекущаяСтрока.Ссылка);
...
&НаКлиенте
Процедура ПереключательТиповПОНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	// Вставить содержимое обработчика.
КонецПроцедуры

&НаКлиенте
Процедура ПереключательТиповПОНачалоВыбораИзСписка(Элемент, СтандартнаяОбработка)
	// Вставить содержимое обработчика.
КонецПроцедуры
