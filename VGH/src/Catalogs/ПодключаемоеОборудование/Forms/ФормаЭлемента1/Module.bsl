...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗапретИзмененияДрайвера = Ложь; //(Объект.Ссылка <> Справочники.ПодключаемоеОборудование.ПустаяСсылка());
	...
	Элементы.ДрайверОборудования.ТолькоПросмотр = Ложь;  //ЗапретИзмененияДрайвера;
	...
	//Объект.ТипОборудования = ТипККТОборудование
	...
	Элементы.СервисФискальногоНакопителя.Видимость = Ложь; //ЗначениеЗаполнено(Объект.Ссылка) И Объект.ТипОборудования = ТипККТОборудование И ПравоДоступаСохранениеДанныхПользователя;
	Элементы.ФормаНастроить.Видимость = ЗначениеЗаполнено(Объект.Ссылка) И ПравоДоступаСохранениеДанныхПользователя;
	Элементы.ГруппаПараметрыРегистрацииККТ.Видимость = Ложь;  //ЗначениеЗаполнено(Объект.Ссылка) И Объект.ТипОборудования = ТипККТОборудование;
