...
Процедура ПриОткрытии(Отказ)
	...
	ТекущееРабочееМесто = ПолучитьРабочееМестоКлиента();
...
"Открыть существующее рабочее место?';uk='Створення нового робочого місця не потрібно. "
"Для даного ідентифікатора клієнта воно вже створене."
